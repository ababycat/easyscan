...
image_pub = rospy.Publisher("results_image", Image)
...
if __name__ == "__main__":
    ...
    camera0 = message_filters.Subscriber('camera/camera0', Image)
    camera1 = message_filters.Subscriber('camera/camera1', Image)
